 ...
 */
define(['angular', 'text!module/facilitator/servicescontract.html'], function (angular, tpl) {
    ...
    return {
        controller: ['$scope', '$routeParams', '$http', '$modal', 'alertSrv', function ($scope, $routeParams, $http, $modal, alertSrv) {		
			...
			$scope.bind = function(){
			    ...
			    $http.get('../webapi/facilitator/services.ashx?act=all&getFlag=8&getMode=0')
			...
			{
			    window.open('../webapi/download.ashx?servicesid='+id);
			}
