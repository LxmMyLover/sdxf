 ...
 */
define(['angular', 'text!module/facilitator/suppliersecurity.html'], function (angular, tpl) {
    ...
    return {
        controller: ['$scope', '$routeParams', '$http', '$modal', 'alertSrv', function ($scope, $routeParams, $http, $modal, alertSrv) {
            ...
            $scope.ModifyPassword = function () {
			    ...
			    $http.get('../webapi/facilitator/userinfochange.ashx?act=changePassword&orinalPassword=' + $scope.entity.orinalPassword + "&newPassword=" + $scope.entity.newPassword)
